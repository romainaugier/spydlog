...
class TestAsyncLoggerConcurrency:
    ...
    def test_multiple_async_loggers(self):
        ...
        logger2 = spydlog.async_logger("async2", spydlog.null_sink_st(), pool)
        logger3 = spydlog.async_logger("async3", spydlog.null_sink_st(), pool)
    ...
    def test_mixed_sync_async_loggers(self):
        ...
        async_logger = spydlog.async_logger("async", spydlog.stdout_color_sink_mt(), pool)
